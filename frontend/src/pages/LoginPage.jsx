  ...
  return (
    <div className="h-screen grid lg:grid-cols-2">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              <h1 className="text-2xl font-bold mt-2">Hey there! You&apos;re back!</h1>
              <p className="text-base-content/60">Let&apos;s get you signed in</p>
            </div>
          </div>
      ...
      <AuthImagePattern
        ...
        subtitle={"Pick up your chats right where you left them."}
      />
    </div>
  );
}
